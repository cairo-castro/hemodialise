...
class SafetyChecklist extends Model
{
    ...
    protected $casts = [
        ...
        'reagent_test_performed' => 'boolean',
        'pressure_sensors_verified' => 'boolean',
        'air_bubble_detector_verified' => 'boolean',
        'patient_identification_confirmed' => 'boolean',
        'vascular_access_evaluated' => 'boolean',
        'av_fistula_arm_washed' => 'boolean',
        'patient_weighed' => 'boolean',
        ...
        'heparin_double_checked' => 'boolean',
        'antisepsis_performed' => 'boolean',
        'vascular_access_monitored' => 'boolean',
        'vital_signs_monitored_during' => 'boolean',
