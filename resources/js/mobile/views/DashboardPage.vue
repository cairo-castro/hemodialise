...
import { SafetyChecklist } from '@mobile/core/domain/entities/SafetyChecklist';
import { Machine } from '@mobile/core/domain/entities/Machine';
import { ChecklistRepository } from '@mobile/core/domain/repositories/ChecklistRepository';
